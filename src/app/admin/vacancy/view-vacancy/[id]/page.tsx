...
const ViewVacancy = () => {
  ...
  const api = useApi();
  const [data, setData] = useState<VacancyView | null>(null);
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await api.get<VacancyView[] | VacancyView>(
          `/api/vacancy/${id}`,
        );
      ...
      <div className="flex-1 ml-79 mr-7 py-10">
        <div className="mt-8 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Link
              href={`/admin/vacancy/edit-vacancy/${id}`}
        ...
        {showModal ? (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-md">
              <h2 className="mb-4 text-xl font-semibold">Delete vacancy?</h2>
