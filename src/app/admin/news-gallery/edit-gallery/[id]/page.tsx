...
const EditNewsGalleryPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await api.put(`/api/news-gallery/${galleryId}`, formData);
      router.push("/admin/news-gallery");
    } catch (err) {
  ...
  const currentImageUrl = item?.image ? buildApiUrl(item.image) : "";
      ...
      <div className="flex-1">
        ...
        >
          <div className="border-b border-[#D9D9D9] px-6 py-4">
            <h2 className="text-2xl font-bold">Edit news gallery</h2>
          </div>
...
export default EditNewsGalleryPage;
